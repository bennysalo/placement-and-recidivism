...
# all_variables <- c(all_predictors, 
#                    "openPrison", "open01", "conditionalReleaseGranted", "cond01", "supervisedParole", "superv01", 
#                    "reoffenceThisTerm")
...
# Subgroups for examining effect of supervision
subset_op0_cr0 <-
  included_sample %>% 
  filter(openPrison == "closed_prison" & conditionalReleaseGranted == "cr_not_granted" )

subset_op1_cr0 <- 
  included_sample %>% 
  filter(openPrison == "open_prison" & conditionalReleaseGranted == "cr_not_granted" )

subset_op1_cr1 <- 
  included_sample %>% 
  filter(openPrison == "open_prison" & conditionalReleaseGranted == "cr_granted" )
